...
shinyUI(shinyUI(navbarPage("Word Predictor",theme = "bootstrap.css",
                           tabPanel("WordPrediction",fluidRow(
                               ...
                               column(1,
                                      h4("Language"),
                                      br(),radioButtons("lang_toggle",label=NULL, choices=c("English","Deutsch"))
                               ),
                               column(5,
                                      h4("Input"),
